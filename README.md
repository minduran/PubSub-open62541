# PubSub-open62541
This project contains an implementation of a **basic console app** allowing user to dynamically manipulate on runtime Connections, WriterGroups, DataSets and DataFields by inputs in the console. This work may help understand the concept of the Publisher Implementation of open62541. This project is written in C++.
